...
public class Ex01 {
	...
	public static void main(String[] args) {
		String hr = "============================================";
		// Circulo
		Circulo c1 = new Circulo(new Ponto(3, 5), 6,"Vermelho");
		Circulo c2 = new Circulo(new Ponto(0, 0), 10, "Laranja");
		...
		Triangulo t = new Triangulo(6, 4, 5,"Verde");
		...
		Retangulo r = new Retangulo(12, 5, "Azul");
